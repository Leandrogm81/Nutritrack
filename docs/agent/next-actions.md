...
- [x] Commitar e enviar a reversão para OpenRouter
...
## Prioridade 2 — Validar cards do Planejador
- [x] Ajustar `WeeklyPlanner.tsx` para manter texto dentro dos cards
- [x] Rodar `npm run lint`
- [x] Rodar `npm run test -- --run`
- [x] Rodar `npm run build`
- [x] Commitar e enviar ajuste visual
- [ ] Conferir cards em produção/mobile após deploy

## Prioridade 3 — Confirmação de instalação Android (ação humana)
...
## Prioridade 4 — Substituir ícone gerado por IA pelo ícone real do usuário (se desejado)
...
## Prioridade 6 — Corrigir encoding do CHANGELOG.md (não bloqueante)
