...
## Prioridade 1 — Publicar correção do timeout 504 da IA
- [ ] Revisar diff de `api/opencode-proxy.ts`, `api/openrouter-proxy.ts`, `vercel.json` e `src/services/geminiService.ts`
- [ ] Commitar e enviar a correção para o GitHub
